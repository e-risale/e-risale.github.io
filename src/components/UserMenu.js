    ...
    return (
        <>
            <div
                ...
                className={`absolute top-full right-0 mt-2 w-64 p-2 rounded-2xl shadow-2xl flex flex-col gap-1 animate-in fade-in slide-in-from-top-2 border z-[100] ${darkMode ? 'bg-[#25262b] border-gray-700' : 'bg-white border-amber-100'}`}
            >
                ...
                {/* Diğer Ayarlar - Opsiyonel (Settings şu an Reader içinde, Global Settings olmayabilir) */}
                {onOpenSettings && (
            ...
            {/* Backdrop for closing relative to the viewport or container?
                If component is used inside a relative container, fixed inset-0 works best for backdrop.
            */}
